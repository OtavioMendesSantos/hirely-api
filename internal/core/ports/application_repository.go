...
type ApplicationRepository interface {
	...
	ListByUserID(ctx context.Context, userID string, orderBy string, orderDir string) ([]*domain.Application, error)
	ListByUserIDWithFilters(ctx context.Context, userID string, statuses []string, orderBy string, orderDir string) ([]*domain.Application, error)
